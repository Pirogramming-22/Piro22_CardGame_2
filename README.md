...
## 💬추가사항
1. 만약 발표가 끝나고 다시 과제 채점을 하신다면 현재 배포된 상태가 아니기 때문에 네이버 소셜 로그인은 테스터 ID 등록이 필요합니다. <br> 네이버 소셜 로그인이 필요하시다면 "22기-유승인" 으로 연락주시면 바로 아이디 등록해드리겠습니다. (카카오톡은 등록 안해도 로그인 가능)
